...
const NAV_COLUMNS: { heading: string; links: LinkSpec[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Redação',   to: `mailto:${CONTACT_EMAIL}?subject=Redação`,    external: true },
      { label: 'Anuncie',   to: `mailto:${CONTACT_EMAIL}?subject=Publicidade`, external: true },
      { label: 'Contato',   to: `mailto:${CONTACT_EMAIL}?subject=Contato`,    external: true },
    ],
  },
  {
    heading: 'Conta',
    ...
    <footer className="footer">
      <div className="footer__top container">
        <div className="footer__newsletter">
          ...
          {status === 'success' ? (
            <p className="footer__newsletter-success" role="status">{message}</p>
          ) : (
          ...
          {status === 'error' && (
            <p className="footer__newsletter-error" role="alert">{message}</p>
          )}
        </div>
